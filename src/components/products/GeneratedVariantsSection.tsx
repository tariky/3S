		...
		<>
				...
				<div className="px-6 py-4 border-b border-gray-100 flex items-center justify-between">
					<div className="flex items-center gap-2">
						...
						<h2 className="font-semibold text-gray-900">
							Generisane kombinacije
						</h2>
					</div>
					<Badge variant="secondary" className="text-xs">
						{generatedVariants.length}{" "}
						{generatedVariants.length === 1 ? "kombinacija" : "kombinacije"}
					</Badge>
				</div>
			...
			<div className="lg:hidden bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
				<Accordion
					type="single"
					collapsible
					defaultValue={defaultExpanded ? "generated-variants" : undefined}
				>
					<AccordionItem value="generated-variants" className="border-0">
