    ...
    >
      ...
      >
        ...
        <div className="mt-3 space-y-1 text-center">
          <p className="text-sm font-semibold">Prebaci fajlove ovdje</p>
            ...
            {typeof description === "string" ? (
              ...
              <>
                {description?.maxFiles &&
                  `Možeš prebaciti ${description.maxFiles} fajl${description.maxFiles !== 1 ? "a" : ""}.`}{" "}
                {description?.maxFileSize &&
                  `${description.maxFiles !== 1 ? "Svaki fajl može biti do" : "Fajl može biti do"} ${description.maxFileSize}.`}{" "}
                {description?.fileTypes &&
                  `Prihvaćeni formati: ${description.fileTypes}.`}
              </>
            )}
          </p>
        </div>
